          ...
          `:l.qy`
            ${this.label?l.qy`
                  <kor-text size="body-2">
                    ${this.label>999?l.qy` 999+ `:l.qy` ${this.label} `}
                  </kor-text>
                `:""}
          `}
    `}attributeChangedCallback(t,r,l){super.attributeChangedCallback(t,r,l),this.dispatchEvent(new Event(t+"-changed"))}getStatusIcon(){let t;switch(this.status){case"error":t="cancel";break;case"warning":t="error";break;case"success":t="check_circle"}return t}}v([(0,u.MZ)({type:Number,reflect:!0})],korBadge.prototype,"label",void 0),v([(0,u.MZ)({type:String,reflect:!0})],korBadge.prototype,"status",void 0),window.customElements.get("kor-badge")||window.customElements.define("kor-badge",korBadge)})();